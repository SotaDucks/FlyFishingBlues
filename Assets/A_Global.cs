...
public class A_Global : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha1)) // 数字键1
        {
            SceneManager.LoadScene("Stream1");
        } if (Input.GetKeyDown(KeyCode.Alpha2)) // 数字键1
        {
            SceneManager.LoadScene("Stream2");
        } if (Input.GetKeyDown(KeyCode.Alpha3)) // 数字键1
        {
            SceneManager.LoadScene("Scene1");
        }if (Input.GetKeyDown(KeyCode.Alpha4)) // 数字键1
        {
